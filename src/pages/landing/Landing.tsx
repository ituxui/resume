      ...
      <div className={Styles.wrapper}>
        ...
        <Section>
          ...
          <Section sublevel={2}>
            <Heading muted size={4} kind='thin' className={classNames(Styles.heading)}>
              Разрабатывал интерфейсы приложений кибербезопасности (rdp protocol), образовательных платформ, строительных компаний, терминалов сбора данных промышленных предприятий, международного оператора доставки грузов, закрытых систем для управляющих жилыми домами команий (далее УК) со встроенным умным домом, систем обработки заявок УК, систем учёта общедомовых, коммерческих и частных объектов имущества, систем видеонаблюдения с искуственным интеллектом, системы учёт пассажиров для аэропорта, лендингов, информационных сайтов.
            </Heading>
            <Heading muted size={4} kind='thin' className={classNames(Styles.heading)}>
        ...
        <Section>
          ...
          <Section sublevel={1} className={CommonStyles.muted}>
            ...
            <Heading muted size={4} kind='thin' className={classNames(Styles.heading)}>
              Ищу команду с отработанными процессами исследований, тестирования и проектировки интерфейсов, <em>удаленную позицию</em> в продуктовой компании, использующую лучшие практики, чтобы применить и углубить экспертизу.<br />Давайте поговорим о Вашем продукте!
            </Heading>
          </Section>
          <Section sublevel={1}>
            <div className={Styles.links}>
